...
<head>
    ...
    <title>Phòng Công Nghệ - IELTS School</title>
    <meta name="description" content="Giới thiệu về Phòng Công Nghệ tại IELTS School - Hỗ trợ IT và phát triển công nghệ học tập.">
...
<body>
    ...
    <!-- Hero section customize cho phòng Công Nghệ -->
    <section class="hero hero-slideshow dept-hero">
        <div class="hero-overlay">
            <div class="container text-center">
                <h1 class="display-4 fw-bold mb-4 text-white">Phòng Công Nghệ</h1>
                <p class="lead fs-5 mb-4 text-white">Hỗ trợ hệ thống IT và Phát triển – Mang công nghệ đến gần học viên</p>
    ...
    <section id="dept-intro" class="container py-5 fade-in">
        ...
        <div class="row mb-5">
            <div class="col-12 text-center">
                <h2 class="mb-4">Giới thiệu Phòng Công Nghệ</h2>
                <p class="lead">Xây dựng và bảo trì website, app học tập, tích hợp công nghệ AI để hỗ trợ giảng dạy IELTS. Chúng tôi mang công nghệ đến gần hơn với học viên, tạo trải nghiệm học tập hiện đại.</p>
            </div>
        </div>
        ...
        <div class="row mb-5">
            <div class="col-12 text-center">
                <img src="../img/kythuat.jpg" alt="Phòng Công Nghệ" class="img-fluid rounded shadow-lg mx-auto d-block" style="max-width: 600px;" onerror="this.src='https://via.placeholder.com/600x400?text=Phòng+Công+Nghệ';">
            </div>
        </div>
        ...
        <div class="row mb-5">
            <div class="col-12">
                ...
                <ul class="list-group list-group-flush mx-auto" style="max-width: 600px;"> <!-- ✅ Căn giữa list -->
                    <li class="list-group-item border-0 px-4 py-3 text-center"><i class="fas fa-check text-orange me-2"></i>Phát triển web/app, bảo mật dữ liệu.</li>
                    <li class="list-group-item border-0 px-4 py-3 text-center"><i class="fas fa-check text-orange me-2"></i>Tích hợp tool học online.</li>
                    <li class="list-group-item border-0 px-4 py-3 text-center"><i class="fas fa-check text-orange me-2"></i>Hỗ trợ kỹ thuật cho toàn trường.</li>
                </ul>
            </div>
        </div>
        ...
        <div class="row mt-5">
            <div class="col-12">
                <h5 class="mb-4 text-center"><i class="fas fa-users text-orange me-2"></i>Đội ngũ Phòng Công Nghệ</h5>
                <div class="row g-4 justify-content-center"> <!-- ✅ Tăng gap để thoáng -->
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 text-center mentor-card"> <!-- ✅ col-lg-4 để 3 cột desktop, cân đối hơn -->
                        <img src="../img/an_danh.jpg" alt="Nguyễn Văn U" class="rounded-circle mx-auto d-block mb-3" style="width: 100px; height: 100px; object-fit: cover;" onerror="this.src='https://via.placeholder.com/100?text=U';">
                        <h6 class="fw-bold mb-2">Nguyễn Ngọc Mạnh</h6>
                        <p class="small text-muted mb-1">Điểm IELTS 7.5 (Overall)</p>
                        <p class="small text-dark mb-0">Trưởng phòng IT, phát triển web và app học tập.</p>
                    </div>

                    <!-- Thành viên 2 -->
                    <div class="col-12 col-sm-6 col-lg-4 text-center mentor-card">
                        <img src="../img/an_danh.jpg" alt="Trần Thị V" class="rounded-circle mx-auto d-block mb-3" style="width: 100px; height: 100px; object-fit: cover;" onerror="this.src='https://via.placeholder.com/100?text=V';">
                        <h6 class="fw-bold mb-2">Trần Thị Vui</h6>
                        <p class="small text-muted mb-1">Điểm IELTS 8.0</p>
                        <p class="small text-dark mb-0">Chuyên viên AI, tích hợp công nghệ hỗ trợ giảng dạy.</p>
                    </div>

                    <!-- Thành viên 3 -->
                    <div class="col-12 col-sm-6 col-lg-4 text-center mentor-card">
                        <img src="../img/an_danh.jpg" alt="Lê Văn X" class="rounded-circle mx-auto d-block mb-3" style="width: 100px; height: 100px; object-fit: cover;" onerror="this.src='https://via.placeholder.com/100?text=X';">
                        <h6 class="fw-bold mb-2">Lê Văn Phước</h6>
                        <p class="small text-muted mb-1">Điểm IELTS 7.0 (Overall)</p>
                        <p class="small text-dark mb-0">Kỹ thuật viên hỗ trợ, bảo trì hệ thống và bảo mật.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-5">
            <div class="col-12 text-center">
                ...
                <a href="mailto:congnghe@ieltschool.com" class="btn btn-outline-orange">Liên hệ phòng ban</a>
            </div>
        </div>
    </section>
